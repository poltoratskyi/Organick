    ...
    <footer className="footer">
      <div className="container">
        <div className="footer__content">
          <div className="footer__content-block footer__content-block_contact">
            <h3 className="footer__content-block-title">Contact Us</h3>

            <ul className="footer__content-block-items">
              <li className="footer__content-block-items-item">
                <span className="footer__content-block-items-item-label">
                  Email
                </span>
              ...
              <li className="footer__content-block-items-item">
                ...
                <p className="footer__content-block-items-item-text">
          ...
          <div className="footer__content-feedback">
            <span className="footer__content-feedback-line"></span>

            <div className="footer__content-feedback-wrapper">
              <div className="footer__content-feedback-logo">
                ...
                <span className="footer__content-feedback-logo-label">
                  Organic
                </span>
              </div>

              <p className="footer__content-feedback-description">
                Get to know more about us and our mission to provide you with
                the best organic products. We are dedicated to promoting a
          ...
          <div className="footer__content-block footer__content-block_utility">
      ...
      <p className="footer__copyright">
        Copyright © <b>Organic</b> | Designed by <b>VictorFlow </b>
